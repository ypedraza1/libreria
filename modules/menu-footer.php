<?php
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="menuR">
                    <ul class="navbar-nav me-3">
                        ...
                        <li class="nav-item"> <a class="nav-link me-2" href="http://localhost/Libreria/vistas/usuario/"> <i class="bi bi-person me-1"> </i> Usuario </a> </li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    echo
      <<< MENUADMIN
        <nav class="navbar navbar-expand-md bg-dark navbar-dark sticky-top border-bottom border-secondary p-2">
          <div class="container-fluid">
