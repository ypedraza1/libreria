...
<head>
    <title id="Titulo"> Catálogo </title>
    <meta charset="UTF-8">
...
<body class="bg-secondary">
            ...
            ?>
                ...
                <div class="col">
                    <div class="card pt-0 p-5 mt-4 bg-secondary border-secondary bg-opacity-50">
                        ...
                        <div class="text-end">
                            <a class="btn btn-outline-primary border border-primary" href="catalogo.php" type="button">Volver</a>
                            <button class="btn btn-primary" id="añadir" onclick="anadir()" type="button">añadir</button>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function anadir(){
            document.getElementById('añadir').innerHTML = "Añadido";
        }
    </script>
</body>
</html>